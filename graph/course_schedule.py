class Solution:
    def canFinish(self, numCourses: int, prerequisites: List[List[int]]) -> bool:import collections
from typing import (
    List,
)
...
class Solution:
    """ https://www.lintcode.com/problem/615/?_from=collection&fromId=161
...
https://stackoverflow.com/questions/54975278/adjacency-list-representation-in-topological-sort
    ...
    def canFinish(self, num_courses: int, prerequisites: List[List[int]]) -> bool:
        ...
        for to_node, from_node in prerequisites:  # TODO build graph from edges given 需要注意的是这里的邻接表 根据incoming edges/outgoing edges皆可 并不妨碍解题
